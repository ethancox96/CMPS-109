...
class inode_state {
   ...
   public:
      ...
      inode_ptr get_root();
      inode_ptr get_cwd();
      void set_cwd(inode_ptr p);
      inode_ptr resolve_pathname(const string& pathname);
      void lsr(string& pathname, ostream& out);
};
...
class base_file {
  ...
  //    virtual void set_root(inode_ptr root);
//      virtual void set_child(inode_ptr parent, inode_ptr child);
};

// class plain_file -
// Used to hold data.
...
class directory: public base_file {
   ...
   public:
      ...
      void set_child(inode_ptr parent, inode_ptr child);
      inode_ptr lookup(const string& name);
      void ls(ostream& out);
      vector<inode_ptr> get_subdirs();
};
