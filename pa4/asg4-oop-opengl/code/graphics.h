...
class object {
   ...
   public:
      ...
      object(shared_ptr<shape> s, vertex v, rgbcolor c) {
         pshape = s;
         center = v;
         color = c;
      }
...
class window {
   ...
   public:
      ...
      static void setpixels (int pix_) {pixels = pix_;}
      static void setthick (const GLfloat& t) {thickness = t;}
      static void setcolor (const rgbcolor& c) {color = c;}
      static void main();
};
